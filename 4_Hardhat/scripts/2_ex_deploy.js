...
async function main() {
  ...
  hardhatSigners = await hre.ethers.getSigners();
  hhSignerFirst = hardhatSigners[0];
  console.log("Hardhat Signer Address:", hhSignerFirst.address);
  // Your code here!
  ...
  // Your code here!
  contractTest = await hre.ethers.getContractAt(contractName, contractAddress, hhSignerFirst);
  console.log("Contract Address:", contractTest.address);
  return;
